...
- **Best detector macro AUROC during adversarial training**: 0.9960
- **Companion detector**: [Shushant/ADAL-Detector-PANCLEF](https://huggingface.co/Shushant/ADAL-Detector-PANCLEF)
...
tokenizer = T5Tokenizer.from_pretrained("Shushant/ADAL_PAN-t5-paraphraser")
model     = T5ForConditionalGeneration.from_pretrained("Shushant/ADAL_PAN-t5-paraphraser")
