...
HF_DETECTOR_REPO      = "adal_v4_detector_raid"     # ← repo name for the detector
HF_PARAPHRASER_REPO   = "adal_v4_paraphrasor_raid"       # ← repo name for the paraphraser
