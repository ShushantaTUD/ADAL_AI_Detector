...
# ── Output paths ──────────────────────────────────────────────────────────────
OUTPUT_DIR            = "./adal_second_version"
...
HF_TOKEN              = "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"        # ← paste your HF write token
...
HF_DETECTOR_REPO      = "ADAL-second-version"     # ← repo name for the detector
HF_PARAPHRASER_REPO   = "ADAL-second-version-t5-paraphraser"       # ← repo name for the paraphraser
...
def train_radar_multievasion():
    ...
    logger.info("═" * 72)
    logger.info("  ADAL v2 — AI-Generated Text Detection via Adversarial Learning")
    logger.info("  (RADAR × RAID extended: 11 attacks, 4 decoding strategies,")
    logger.info("   asymmetric label smoothing, TPR@1%FPR objective, isotonic cal.)")
