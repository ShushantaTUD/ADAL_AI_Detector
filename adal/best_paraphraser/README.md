...
- **Best detector macro AUROC during adversarial training**: 0.9940
- **Companion detector**: [Shushant/ADAL-detector-large](https://huggingface.co/Shushant/ADAL-detector-large)
...
tokenizer = T5Tokenizer.from_pretrained("Shushant/adal-paraphraser-large")
model     = T5ForConditionalGeneration.from_pretrained("Shushant/adal-paraphraser-large")
