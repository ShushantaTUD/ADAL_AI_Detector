...
- **Companion detector**: [Shushant/adal_v5_panclef](https://huggingface.co/Shushant/adal_v5_panclef)
...
tokenizer = T5Tokenizer.from_pretrained("Shushant/adal_v5_panclef-paraphraser")
model     = T5ForConditionalGeneration.from_pretrained("Shushant/adal_v5_panclef-paraphraser")
