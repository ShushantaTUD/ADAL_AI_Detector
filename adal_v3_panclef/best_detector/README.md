...
tokenizer = RobertaTokenizer.from_pretrained("Shushant/adal-v3-panclef")
model     = RobertaForSequenceClassification.from_pretrained("Shushant/adal-v3-panclef")
model.eval()
