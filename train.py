"""
ADAL AI-Generated Text Detection using Adversarial Learning — Multi-Generator + Multi-Evasion Adversarial Training
====================================================================
...
HF_TOKEN              = "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"        # ← paste your HF write token
...
HF_DETECTOR_REPO      = "ADAL-detector-large"     # ← repo name for the detector
HF_PARAPHRASER_REPO   = "adal-paraphraser-large"       # ← repo name for the paraphraser
